...
class _TutorEditInfoState extends State<TutorEditInfo> {
  ...
  // 🌟 iOS COMPATIBLE AUDIO PICKER
  Future<void> _pickAudio() async {
    try {
      // iOS par FileType.audio grayed-out issue karta hai, isliye hum custom use kar rahe hain
      FilePickerResult? result = await FilePicker.pickFiles(
        type: FileType.custom,
        allowedExtensions: ['mp3', 'm4a', 'wav', 'aac'], // iOS compatible formats
        allowMultiple: false,
      );
